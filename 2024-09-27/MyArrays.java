public class MyArrays {
  ...
  public static void main (String[] args) {
    ...
    if (Arrays.equals(testArray, returnCopy(testArray))){
    ...
    if (Arrays.equals(testArray1, returnCopy(testArray1))){
      System.out.println("contents equal");
    }
    ...
    if (Arrays.equals(Arraycat, concatArray(testArray,testArray1))){
      System.out.println("contents equal");
    }
    ...
    if (Arrays.equals(Arraycat, concatArray(testArray,testArray))){
      System.out.println("contents equal");
    }
  }
